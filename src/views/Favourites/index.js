      ...
      axios.delete('https://api-appnytimes.herokuapp.com/book/favourites/delete', {
        ...
        .then(response => {
          if (response.status === 200) {
            NotificationManager.success(`Book was deleted successfully`, 'Success');
          }
          ...
          <h3 className="page-title">My Favourites</h3>
          {
            state.favourites.length > 0 ?
                      ...
                      <Card
                        ...
                        cover={
                          <img
                            ...
                            alt="example"
                            src={favourite.book_image}
                          />
                        }
                        actions={[
                          <ShoppingCartOutlined className="add-to-cart" key="basket" title="Add To Cart" onClick={() => addToCart(favourite)}/>,
                          <HeartFilled key="favourite" style={{color: '#f28232'}} />,
                          <CloseCircleFilled className="delete-icon" key="remove" title="Delete" onClick={() => deleteBookFromFavourites(favourite)}/>
                        ]}
                      >
                        <Meta
              ...
              <div className="empty-favourites">
                ...
                <span className="info">Your favourite list is empty</span>
                <Link to={HOME}>
